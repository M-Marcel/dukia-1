                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-3 m-t-30">
                                        <div class=" text-center">
                                            <p class="text-muted">Gold Naira Value</p>
                                        ...
                                        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title mt-0" id="myModalLabel">Gold Naira Value</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <form class="" method="POST" action="/gold-value">
                                                        {{ csrf_field() }}
                                                    <div class="modal-body">
                                                            <label>Input your value here</label> 
                                                            <input type="text" class="form-control" name="goldvalue" value=""
                                                            parsley-type="text" placeholder="Enter a value here"/>
